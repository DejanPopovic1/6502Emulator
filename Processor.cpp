...
Processor::Processor(){
    ...
    this->lookup =
            {
                    {"BRK", &a::BRK, &a::IMM, 7 }, {"ORA", &a::ORA, &a::IIX, 6 }, {"???", &a::XXX, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 8 }, {"???", &a::NOP, &a::IMP, 3 }, {"ORA", &a::ORA, &a::ZPA, 3 }, {"ASL", &a::ASL, &a::ZPA, 5 }, {"???", &a::XXX, &a::IMP, 5 }, {"PHP", &a::PHP, &a::IMP, 3 }, {"ORA", &a::ORA, &a::IMM, 2 }, {"ASL", &a::ASL, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"???", &a::NOP, &a::IMP, 4 }, {"ORA", &a::ORA, &a::ABS, 4 }, {"ASL", &a::ASL, &a::ABS, 6 }, {"???", &a::XXX, &a::IMP, 6 },
                    ...
                    {"JSR", &a::JSR, &a::ABS, 6 }, {"AND", &a::AND, &a::IIX, 6 }, {"???", &a::XXX, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 8 }, {"BIT", &a::BIT, &a::ZPA, 3 }, {"AND", &a::AND, &a::ZPA, 3 }, {"ROL", &a::ROL, &a::ZPA, 5 }, {"???", &a::XXX, &a::IMP, 5 }, {"PLP", &a::PLP, &a::IMP, 4 }, {"AND", &a::AND, &a::IMM, 2 }, {"ROL", &a::ROL, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"BIT", &a::BIT, &a::ABS, 4 }, {"AND", &a::AND, &a::ABS, 4 }, {"ROL", &a::ROL, &a::ABS, 6 }, {"???", &a::XXX, &a::IMP, 6 },
                    ...
                    {"RTI", &a::RTI, &a::IMP, 6 }, {"EOR", &a::EOR, &a::IIX, 6 }, {"???", &a::XXX, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 8 }, {"???", &a::NOP, &a::IMP, 3 }, {"EOR", &a::EOR, &a::ZPA, 3 }, {"LSR", &a::LSR, &a::ZPA, 5 }, {"???", &a::XXX, &a::IMP, 5 }, {"PHA", &a::PHA, &a::IMP, 3 }, {"EOR", &a::EOR, &a::IMM, 2 }, {"LSR", &a::LSR, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"JMP", &a::JMP, &a::ABS, 3 }, {"EOR", &a::EOR, &a::ABS, 4 }, {"LSR", &a::LSR, &a::ABS, 6 }, {"???", &a::XXX, &a::IMP, 6 },
                    ...
                    {"RTS", &a::RTS, &a::IMP, 6 }, {"ADC", &a::ADC, &a::IIX, 6 }, {"???", &a::XXX, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 8 }, {"???", &a::NOP, &a::IMP, 3 }, {"ADC", &a::ADC, &a::ZPA, 3 }, {"ROR", &a::ROR, &a::ZPA, 5 }, {"???", &a::XXX, &a::IMP, 5 }, {"PLA", &a::PLA, &a::IMP, 4 }, {"ADC", &a::ADC, &a::IMM, 2 }, {"ROR", &a::ROR, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"JMP", &a::JMP, &a::IND, 5 }, {"ADC", &a::ADC, &a::ABS, 4 }, {"ROR", &a::ROR, &a::ABS, 6 }, {"???", &a::XXX, &a::IMP, 6 },
                    ...
                    {"???", &a::NOP, &a::IMP, 2 }, {"STA", &a::STA, &a::IIX, 6 }, {"???", &a::NOP, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 6 }, {"STY", &a::STY, &a::ZPA, 3 }, {"STA", &a::STA, &a::ZPA, 3 }, {"STX", &a::STX, &a::ZPA, 3 }, {"???", &a::XXX, &a::IMP, 3 }, {"DEY", &a::DEY, &a::IMP, 2 }, {"???", &a::NOP, &a::IMP, 2 }, {"TXA", &a::TXA, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"STY", &a::STY, &a::ABS, 4 }, {"STA", &a::STA, &a::ABS, 4 }, {"STX", &a::STX, &a::ABS, 4 }, {"???", &a::XXX, &a::IMP, 4 },
                    ...
                    {"LDY", &a::LDY, &a::IMM, 2 }, {"LDA", &a::LDA, &a::IIX, 6 }, {"LDX", &a::LDX, &a::IMM, 2 }, {"???", &a::XXX, &a::IMP, 6 }, {"LDY", &a::LDY, &a::ZPA, 3 }, {"LDA", &a::LDA, &a::ZPA, 3 }, {"LDX", &a::LDX, &a::ZPA, 3 }, {"???", &a::XXX, &a::IMP, 3 }, {"TAY", &a::TAY, &a::IMP, 2 }, {"LDA", &a::LDA, &a::IMM, 2 }, {"TAX", &a::TAX, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"LDY", &a::LDY, &a::ABS, 4 }, {"LDA", &a::LDA, &a::ABS, 4 }, {"LDX", &a::LDX, &a::ABS, 4 }, {"???", &a::XXX, &a::IMP, 4 },
                    ...
                    {"CPY", &a::CPY, &a::IMM, 2 }, {"CMP", &a::CMP, &a::IIX, 6 }, {"???", &a::NOP, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 8 }, {"CPY", &a::CPY, &a::ZPA, 3 }, {"CMP", &a::CMP, &a::ZPA, 3 }, {"DEC", &a::DEC, &a::ZPA, 5 }, {"???", &a::XXX, &a::IMP, 5 }, {"INY", &a::INY, &a::IMP, 2 }, {"CMP", &a::CMP, &a::IMM, 2 }, {"DEX", &a::DEX, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 2 }, {"CPY", &a::CPY, &a::ABS, 4 }, {"CMP", &a::CMP, &a::ABS, 4 }, {"DEC", &a::DEC, &a::ABS, 6 }, {"???", &a::XXX, &a::IMP, 6 },
                    ...
                    {"CPX", &a::CPX, &a::IMM, 2 }, {"SBC", &a::SBC, &a::IIX, 6 }, {"???", &a::NOP, &a::IMP, 2 }, {"???", &a::XXX, &a::IMP, 8 }, {"CPX", &a::CPX, &a::ZPA, 3 }, {"SBC", &a::SBC, &a::ZPA, 3 }, {"INC", &a::INC, &a::ZPA, 5 }, {"???", &a::XXX, &a::IMP, 5 }, {"INX", &a::INX, &a::IMP, 2 }, {"SBC", &a::SBC, &a::IMM, 2 }, {"NOP", &a::NOP, &a::IMP, 2 }, {"???", &a::SBC, &a::IMP, 2 }, {"CPX", &a::CPX, &a::ABS, 4 }, {"SBC", &a::SBC, &a::ABS, 4 }, {"INC", &a::INC, &a::ABS, 6 }, {"???", &a::XXX, &a::IMP, 6 },
